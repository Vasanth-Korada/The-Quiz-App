...
class VGPage extends StatefulWidget {
  @override
  _VGState createState() => _VGState();
}

class _VGState extends State<VGPage> {
  Quiz quiz;
  List<Results> results;

  Future<void> fetchQuestions() async {
    var res =
        await http.get("https://opentdb.com/api.php?amount=50&category=15");
